		...
		<div class="main-content-inner">
			...
			<div class="page-content">
				...
				<div class="row">
					...
					<div class="col-xs-12">
						<!-- PAGE CONTENT BEGINS -->						
						<form class="form-horizontal" role="form" style="margin: 15px 0px;" method="post" action="<?php echo base_url('item/processAdd');?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" placeholder="Harga" class="form-control" name="harga" required />
								</div>
							</div>
							...
							<!-- <div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" placeholder="Discount" class="form-control" name="discount" />
								</div>
							</div> -->
