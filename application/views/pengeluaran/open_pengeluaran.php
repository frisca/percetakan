				...
				<div class="modal" id="myModal">
				    <div class="modal-dialog">
					    <div class="modal-content">
					        ...
					        <form action="<?php echo base_url('pengeluaran/processOpenPengeluaran')?>" method="post">
				...
				<div id="show_modal" class="modal">
				    <div class="modal-dialog">
					    <div class="modal-content">
					        ...
					        <form action="<?php echo base_url('pengeluaran/processOpenEditPengeluaran')?>" method="post">
					        	<div class="modal-body">
					            	<div class="row">
