	...
	<div class="main-content">
		<div class="main-content-inner">
			...
			<div class="page-content">
				...
				<form style="margin-top:50px;" method="post" action="<?php echo base_url('penjualan/open_checkout/' . $header_penjualan->id_header_penjualan);?>">
				...
				<div class="modal" id="myModal">
				    <div class="modal-dialog">
				      <div class="modal-content">
				        ...
				        <form action="<?php echo base_url('penjualan/processOpenAddPenjualan')?>" method="post" enctype="multipart/form-data">
					        <!-- Modal body -->
				...
				<div id="show_modal" class="modal">
				  	<div class="modal-dialog">
					    <div class="modal-content">
					        ...
					        <form action="<?php echo base_url('penjualan/processOpenEditPenjualan')?>" method="post" enctype="multipart/form-data">
						      	<div class="modal-body">
							        <div class="row">
